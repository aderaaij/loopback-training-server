...
class TrainingClient:
    ...
    async def validate_plan(self, plan_id: str) -> list | dict:
        """Run the deterministic schedule-soundness check for a plan."""
        return await self._request("POST", f"/api/plans/{plan_id}/validate")
